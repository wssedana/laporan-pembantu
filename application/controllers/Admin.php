...
class Admin extends CI_Controller
{
    ...
    public function dash1($start = null)
    {
        ...
        $data['AllKecamatan'] = $this->Dashboard_model->getAllKecamatan();
    ...
    public function dash3($start = null)
    {
        ...
        $data['AllZona'] = $this->Dashboard_model->getAllZona();
    ...
    {
        $config['base_url'] = base_url('admin/getPerZona1/' . $idKecamatan . '/' . $periode . '/');
        $config['per_page'] = 4;
