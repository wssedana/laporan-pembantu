                        ...
                        <table class="table" width="100%">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th rowspan="2" width="8%">TAP PIPA</th>
                                    <th rowspan="2" width="18%">LOKASI MANOMETER</th>
                                    <th colspan="2" width="17%">JAM PUNCAK</th>
                                    <th rowspan="2" width="11%">MALAM</th>
                                    <th rowspan="2" width="15%">INDIKATOR PEL</th>
                                    <th rowspan="2" width="12%">JUMLAH SR</th>
                    ...
                    <table class="table" width="100%">
                        <thead>
                            <tr>
                                ...
                                <td width="8%" style="padding: 0px;  border: 0;"></td>
                                <td width="9%" style="padding: 0px;  border: 0;"></td>
                                <td width="11%" style="padding: 0px;  border: 0;"></td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="11%"><?php if ($bc['masa'] == "Malam") {
                                                    echo $bc['presure'] . '<small><i>bar</i></small>';
                                                } ?>
                                </td>
                                <td width="15%"></td>
