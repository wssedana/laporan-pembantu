                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= base_url('Admin/getPresurePerMasa/' . $periode . '/' . $row['id_zona']); ?>">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Zona <?= $row['zona'] . " (" . $row['masa'] . ")"; ?></div>
                                </a>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <?php foreach ($masa as $row) {
                        $id_zona = $row['id_zona'];
                        $hitungMano = $this->Dashboard_model->jumlahManoZona($id_zona);
                        $rumus2 = ($row['standar'] / $hitungMano['total_manometer_zona']) * 100;
                        $width = $rumus2 . "%";
                        ...
                        <h4 class="small font-weight-bold"><?= $row['masa']; ?><span class="float-right"><?= number_format($rumus2, 1, ",", "."); ?>%</span></h4>
