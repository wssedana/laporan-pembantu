...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4">
            <form action="<?= base_url('Admin/dash2'); ?>" method="POST">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= base_url('Admin/getPerZona2/' . $row['kecamatan'] . '/' . $periode) ?>">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ranting</h6>
                </div>
                <div class="card-body">
                    <?php foreach ($perKecamatanNoLimit as $row) {
                        ...
                        <h4 class="small font-weight-bold"><?= $row['kecamatan']; ?><span class="float-right"><?= number_format($row['rumus'], 1, ",", "."); ?>%</span></h4>
