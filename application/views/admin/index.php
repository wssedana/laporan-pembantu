            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-2">
                        <canvas id="lineManoPerZona"></canvas>
                    </div>
                    <div class="mt-4 text-center small">
                        <span class="mr-2">
...
<script type="text/javascript">
    ...
    var ctx2 = document.getElementById('lineManoPerZona').getContext('2d');
    var chart2 = new Chart(ctx2, {
        ...
        data: {
            labels: [
                <?php
                if (count($AllZona) > 0) {
                    foreach ($AllZona as $row) {
                       $id_zona = $row['id_zona'];
                        $hitungMano = $this->Dashboard_model->getManoPerZona($id_zona);
                        echo "'" . $row['zona'] . "',";
                    }
                }
                ?>
